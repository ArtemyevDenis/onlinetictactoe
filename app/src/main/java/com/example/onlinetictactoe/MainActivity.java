...
public class MainActivity extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://tictactoe-863a4-default-rtdb.firebaseio.com");
                ...
                if (opponentFound){
                    if (snapshot.hasChildren()){
                        for (DataSnapshot connections : snapshot.getChildren()){
                            ...
                            int playersCount = (int)connections.getChildrenCount();
    ...
    private void applyPlayerTurn(String playerUniqueId2){
        if (playerUniqueId2.equals(playerUniqueId)){
            player1Layout.setBackgroundResource(R.drawable.round_back_dark_purple_stroke);
            player2Layout.setBackgroundResource(R.drawable.round_back_dark_purple);
        }
        else
        {
            player2Layout.setBackgroundResource(R.drawable.round_back_dark_purple_stroke);
            player1Layout.setBackgroundResource(R.drawable.round_back_dark_purple);
        }
    }
